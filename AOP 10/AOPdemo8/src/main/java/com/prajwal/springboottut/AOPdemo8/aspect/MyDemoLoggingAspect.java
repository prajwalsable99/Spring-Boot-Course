...
public class MyDemoLoggingAspect {
    ...
    @Around("com.prajwal.springboottut.AOPdemo8.aspect.PointCutExp.forFortune()")
    ...
    @After("com.prajwal.springboottut.AOPdemo8.aspect.PointCutExp.forFind()")
    ...
    @AfterThrowing(pointcut = "com.prajwal.springboottut.AOPdemo8.aspect.PointCutExp.forFind()" , throwing= "exec")
    ...
    @AfterReturning( pointcut = "com.prajwal.springboottut.AOPdemo8.aspect.PointCutExp.forFind()" ,returning = "result")
...
//    @Before("com.prajwal.springboottut.AOPdemo8.aspect.PointCutExp.forDaoPackage()")
//
