...
public class MyDemoLoggingAspect {
    ...
    @After("com.prajwal.springboottut.AOPdemo7.aspect.PointCutExp.forFind()")
    public void beforeAfterAdvice(JoinPoint joinPoint){
        System.out.println("------------------------------------------------------------------------------------------");
    ...
    @AfterThrowing(pointcut = "com.prajwal.springboottut.AOPdemo7.aspect.PointCutExp.forFind()" , throwing= "exec")
    ...
    @AfterReturning( pointcut = "com.prajwal.springboottut.AOPdemo7.aspect.PointCutExp.forFind()" ,returning = "result")
...
//    @Before("com.prajwal.springboottut.AOPdemo7.aspect.PointCutExp.forDaoPackage()")
//
