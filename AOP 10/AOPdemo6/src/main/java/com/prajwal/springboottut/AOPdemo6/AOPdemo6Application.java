package com.prajwal.springboottut.AOPdemo6;

import com.prajwal.springboottut.AOPdemo6.dao.AccountDAO;
...
public class AOPdemo6Application {

	public static void main(String[] args) {
		SpringApplication.run(AOPdemo6Application.class, args);
	}
